import STRIPE_KEYS from "../assets/129.secret.js";

const d = document,
  $tacos = d.getElementById("tacos"),
  $template = d.getElementById("taco_template").content,
    ...
    if (isOk) {
      Stripe(STRIPE_KEYS.public)
        .redirectToCheckout({
          ...
          mode: "subscription",
          successUrl:
            "http://127.0.0.1:5500/04. Ejercicios Ajax/assets/129.stripe_success.html",
          cancelUrl:
